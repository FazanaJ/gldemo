...
void move_entity_analog(struct controller_data hold, struct entity_t* entity, camera_t camera) {
...
void move_camera_analog(struct controller_data hold, camera_t *camera){
